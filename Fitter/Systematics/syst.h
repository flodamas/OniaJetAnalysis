...
map<anabin, syst> readSyst_all(const char* collSystem="", const char* poiname="NJpsi", const char* nameTag="016", bool readEffSyst=false, bool readAccSyst=false, bool readSigSyst=true,const char* prependPath="", bool doPrintTex=false, const char* texName="Systematics/systs.tex");
