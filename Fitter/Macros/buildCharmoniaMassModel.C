...
bool buildCharmoniaMassModel(RooWorkspace& ws, struct CharmModel model, map<string, string> parIni,
	...
	if (incJpsi) {
		if (!addSignalMassModel(ws, "Jpsi", model.Jpsi.Mass, parIni, isPbPb)) {
			cout << "[ERROR] Adding Jpsi Mass Model failed" << endl;
			return false;
		}
	}
	if (incPsi2S) {
		if (!addSignalMassModel(ws, "Psi2S", model.Psi2S.Mass, parIni, isPbPb)) {
			cout << "[ERROR] Adding Psi(2S) Mass Model failed" << endl;
			return false;
		}
	}
	if (incBkg) {
		if (!addBackgroundMassModel(ws, "Bkg", model.Bkg.Mass, parIni, isPbPb)) {
			cout << "[ERROR] Adding Background Mass Model failed" << endl;
			return false;
		}
	}
	...
	if (!incJpsi && !incPsi2S && !incBkg) {
		cout << "[ERROR] User did not include any model, please fix your input settings!" << endl;
		return false;
	}
...
bool addBackgroundMassModel(RooWorkspace& ws, string object, MassModel model, map<string, string> parIni, bool isPbPb) {
	...
	switch (model) {
		case (MassModel::Uniform):
			...
			cout << Form("[INFO] %s Background Uniform PDF in %s included", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
			break;
		...
		case (MassModel::Chebychev1):
			...
			if (!(
				...
				cout << Form("[ERROR] Initial parameters where not found for %s Background First Order Chebychev in %s", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
				return false;
			}
			...
			cout << Form("[INFO] %s Background 1st Order Chebychev PDF in %s included", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
			break;
		...
		case (MassModel::Chebychev2):
			...
			if (!(
				...
				cout << Form("[ERROR] Initial parameters where not found for %s Background Second Order Chebychev in %s", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
				return false;
			}
			...
			cout << Form("[INFO] %s Background 2nd Order Chebychev PDF in %s included", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
			break;
		...
		case (MassModel::Chebychev3):
			...
			if (!(
				...
				cout << Form("[ERROR] Initial parameters where not found for %s Background Third Order Chebychev in %s", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
				return false;
			}
			...
			cout << Form("[INFO] %s Background 3rd Order Chebychev PDF in %s included", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
			break;
		...
		case (MassModel::Chebychev4):
			...
			if (!(
				...
				cout << Form("[ERROR] Initial parameters where not found for %s Background Fourth Order Chebychev in %s", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
				return false;
			}
			...
			cout << Form("[INFO] %s Background 4th Order Chebychev PDF in %s included", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
			break;
		...
		case (MassModel::Chebychev5):
			...
			if (!(
				...
				cout << Form("[ERROR] Initial parameters where not found for %s Background Fifth Order Chebychev in %s", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
				return false;
			}
			...
			cout << Form("[INFO] %s Background 5th Order Chebychev PDF in %s included", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
			break;
		...
		case (MassModel::Chebychev6):
			...
			if (!(
				...
				cout << Form("[ERROR] Initial parameters where not found for %s Background Sixth Order Chebychev in %s", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
				return false;
			}
			...
			cout << Form("[INFO] %s Background 6th Order Chebychev PDF in %s included", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
			break;
		...
		case (MassModel::ExpChebychev1):
			...
			if (!(
			      parIni.count(Form("lambda1_%s_%s", object.c_str(), (isPbPb ? "PbPb" : "PP"))))) {
				cout << Form("[ERROR] Initial parameters where not found for %s Background First Order Exponential Chebychev in %s", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
				return false;
			}
			...
			cout << Form("[INFO] %s Background 1st Order Exponential Chebychev PDF in %s included", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
			break;
		...
		case (MassModel::ExpChebychev2):
			...
			if (!(
			      parIni.count(Form("lambda1_%s_%s", object.c_str(), (isPbPb ? "PbPb" : "PP"))),
			      parIni.count(Form("lambda2_%s_%s", object.c_str(), (isPbPb ? "PbPb" : "PP"))))) {
				cout << Form("[ERROR] Initial parameters where not found for %s Background Second Order Exponential Chebychev in %s", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
				return false;
			}
			...
			cout << Form("[INFO] %s Background 2nd Order Exponential Chebychev PDF in %s included", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
			break;
		...
		case (MassModel::ExpChebychev3):
			...
			if (!(
			      ...
			      parIni.count(Form("lambda2_%s_%s", object.c_str(), (isPbPb ? "PbPb" : "PP"))),
			      parIni.count(Form("lambda3_%s_%s", object.c_str(), (isPbPb ? "PbPb" : "PP"))))) {
				cout << Form("[ERROR] Initial parameters where not found for %s Background Third Order Exponential Chebychev in %s", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
				return false;
			}
			...
			cout << Form("[INFO] %s Background 3rd Order Exponential Chebychev PDF in %s included", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
			break;
		...
		case (MassModel::ExpChebychev4):
			...
			if (!(
			      ...
			      parIni.count(Form("lambda3_%s_%s", object.c_str(), (isPbPb ? "PbPb" : "PP"))),
			      parIni.count(Form("lambda4_%s_%s", object.c_str(), (isPbPb ? "PbPb" : "PP"))))) {
				cout << Form("[ERROR] Initial parameters where not found for %s Background Fourth Order Exponential Chebychev in %s", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
				return false;
			}
			...
			cout << Form("[INFO] %s Background 4th Order Exponential Chebychev PDF in %s included", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
			break;
		...
		case (MassModel::ExpChebychev5):
			...
			if (!(
			      ...
			      parIni.count(Form("lambda4_%s_%s", object.c_str(), (isPbPb ? "PbPb" : "PP"))),
			      parIni.count(Form("lambda5_%s_%s", object.c_str(), (isPbPb ? "PbPb" : "PP"))))) {
				cout << Form("[ERROR] Initial parameters where not found for %s Background Fifth Order Exponential Chebychev in %s", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
				return false;
			}
			...
			cout << Form("[INFO] %s Background 5th Order Exponential Chebychev PDF in %s included", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
			break;
		...
		case (MassModel::ExpChebychev6):
			...
			if (!(
			      ...
			      parIni.count(Form("lambda5_%s_%s", object.c_str(), (isPbPb ? "PbPb" : "PP"))),
			      parIni.count(Form("lambda6_%s_%s", object.c_str(), (isPbPb ? "PbPb" : "PP"))))) {
				cout << Form("[ERROR] Initial parameters where not found for %s Background Sixth Order Exponential Chebychev in %s", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
				return false;
			}
			...
			cout << Form("[INFO] %s Background 6th Order Exponential Chebychev PDF in %s included", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
			break;
		...
		case (MassModel::Exponential):
			...
			if (!(
			      parIni.count(Form("lambda1_%s_%s", object.c_str(), (isPbPb ? "PbPb" : "PP"))))) {
				cout << Form("[ERROR] Initial parameters where not found for %s Background Exponential in %s", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
				return false;
			}
			...
			cout << Form("[INFO] %s Background Exponential PDF in %s included", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
			break;

		default:

			cout << "[ERROR] Selected Background Mass Model: " << parIni[Form("Model_%s_%s", object.c_str(), (isPbPb ? "PbPb" : "PP"))] << " has not been implemented" << endl;
			return false;
	}
	...
	switch (model) {
		case (MassModel::SingleGaussian):
			...
			if (!(
				...
				cout << Form("[ERROR] Initial parameters where not found for %s Single Gaussian Model in %s", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
				return false;
			}
			...
			cout << Form("[INFO] %s Single Gaussian PDF in %s included", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
			break;
		...
		case (MassModel::DoubleGaussian):
			...
			if (!(
				...
				cout << Form("[ERROR] Initial parameters where not found for %s Double Gaussian Model in %s", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
				return false;
			}
			...
			cout << Form("[INFO] %s Double Gaussian PDF in %s included", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
			break;
		...
		case (MassModel::SingleCrystalBall):
			...
			if (!(
				...
				cout << Form("[ERROR] Initial parameters where not found for %s Single Crystal Ball Model in %s", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
				return false;
			}
		...
		case (MassModel::ExtendedCrystalBall): // double-sided Crystal Ball, see RooCrystalBall documentation
			...
			if (!(
				...
				cout << Form("[ERROR] Initial parameters where not found for %s Extended Crystal Ball Model in %s", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
				return false;
			}
      ...
      */
			...
			cout << Form("[INFO] %s Extended Crystal Ball PDF in %s included", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
			break;
		...
		case (MassModel::DoubleCrystalBall):
			...
			if (!(
			      ...
			      parIni.count(Form("n2_%s_%s", object.c_str(), (isPbPb ? "PbPb" : "PP"))) &&
			      parIni.count(Form("f_%s_%s", object.c_str(), (isPbPb ? "PbPb" : "PP"))))) {
				cout << Form("[ERROR] Initial parameters where not found for %s Double Crystal Ball Model in %s", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
				return false;
			}
			...
			cout << Form("[INFO] %s Double Crystal Ball PDF in %s included", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
			break;
		...
		case (MassModel::GaussianAndCrystalBall):
			...
			if (!(
			      ...
			      parIni.count(Form("n_%s_%s", object.c_str(), (isPbPb ? "PbPb" : "PP"))) &&
			      parIni.count(Form("f_%s_%s", object.c_str(), (isPbPb ? "PbPb" : "PP"))))) {
				cout << Form("[ERROR] Initial parameters where not found for %s Gaussian and Crystal Ball Model in %s", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
				return false;
			}
			...
			cout << Form("[INFO] %s Gaussian and Crystal Ball PDF in %s included", object.c_str(), (isPbPb ? "PbPb" : "PP")) << endl;
			break;

		default:

			cout << "[ERROR] Selected Signal Mass Model: " << parIni[Form("Model_%s_%s", object.c_str(), (isPbPb ? "PbPb" : "PP"))] << " has not been implemented" << endl;
			return false;
	}
