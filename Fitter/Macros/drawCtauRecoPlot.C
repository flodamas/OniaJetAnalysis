...
void drawCtauRecoPlot(RooWorkspace& myws,         // Local workspace
	...
	myws.pdf(pdfTotName.c_str())->plotOn(frame, Name("PDF"), Normalization(myws.data(dsOSName.c_str())->sumEntries(), RooAbsReal::NumEvent), LineColor(kRed + 2), LineStyle(1), Precision(1e-4), NormRange("CtauRecoFullWindow"), Range("CtauRecoWindow"));
