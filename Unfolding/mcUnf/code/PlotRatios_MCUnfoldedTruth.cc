...
void plot(bool doPrompt = false, bool doMid = true){
  ...
  if(doPrompt && doMid){
    filename1 = "../unfOutput/step1/UnfoldedDistributions_Prompt_Mid_8iter_49z15ptBins7zMeasBinsDiag.root";
    filename2 = "../unfOutput/step2/UnfoldedDistributions_Prompt_Mid_8iter_49z15ptBins7zMeasBinsDiag.root";
    filename3 = "../unfOutput/step3/UnfoldedDistributions_Prompt_Mid_8iter_49z15ptBins7zMeasBinsDiag.root";
    filename4 = "../unfOutput/step4/UnfoldedDistributions_Prompt_Mid_8iter_49z15ptBins7zMeasBinsDiag.root";
  }

  if(!doPrompt && doMid){
    filename1 = "../unfOutput/step1/UnfoldedDistributions_NonPrompt_Mid_8iter_49z15ptBins7zMeasBinsDiag.root";
    filename2 = "../unfOutput/step2/UnfoldedDistributions_NonPrompt_Mid_8iter_49z15ptBins7zMeasBinsDiag.root";
    filename3 = "../unfOutput/step3/UnfoldedDistributions_NonPrompt_Mid_8iter_49z15ptBins7zMeasBinsDiag.root";
    filename4 = "../unfOutput/step4/UnfoldedDistributions_NonPrompt_Mid_8iter_49z15ptBins7zMeasBinsDiag.root";
  }
  ...
  */
  ...
  hZMeas->GetYaxis()->SetTitle("dN/dz (per 0.14)");
