...
void create(bool doPrompt = true, bool doMid = true, Int_t stepNumber = 1, double SF = 1.1){
  ...
  inputName = "mcUnfNewMidBins/code/diag4DMatrixInvMid.root";
  
  outputName = "mcUnfNewMidBins/code/diag4DMatrixResponseInvMid.root";
...
void createRooUnfoldResponse50z15ptBinsDiagMid(){
