...
void plot(bool doPrompt = false, bool doMid = true){
  ...
  */
  ...
  TH1D *hZMeas;
  hZMeas=(TH1D*)file3->Get("hMSme_5;1");
  ...
  */
  ...
  TH1D *hZTrue1;
  hZTrue1=(TH1D*)file3->Get("hMTru_5;1");
  TH1D *hZTrue2;
  hZTrue2=(TH1D*)file3->Get("hMTru_6;1");
  TH1D *hZTrue3;
  hZTrue3=(TH1D*)file3->Get("hMTru_7;1");
  TH1D *hZTrue4;
  hZTrue4=(TH1D*)file3->Get("hMTru_8;1");
  TH1D *hZTrue5;
  hZTrue5=(TH1D*)file3->Get("hMTru_9;1");

  TH1D *hZTrue = (TH1D*)hZTrue1->Clone("hZTrue");
  hZTrue->Add(hZTrue2);
  hZTrue->Add(hZTrue3);
  hZTrue->Add(hZTrue4);
  hZTrue->Add(hZTrue5);
  ...
  */
  ...
  hZUnf_SI1_1=(TH1D*)file1->Get("hMUnf_5_Iter3;1");
  hZUnf_SI1_2=(TH1D*)file1->Get("hMUnf_6_Iter3;1");
  hZUnf_SI1_3=(TH1D*)file1->Get("hMUnf_7_Iter3;1");
  hZUnf_SI1_4=(TH1D*)file1->Get("hMUnf_8_Iter3;1");
  hZUnf_SI1_5=(TH1D*)file1->Get("hMUnf_9_Iter3;1");

  hZUnf_SI1=(TH1D*)hZUnf_SI1_1->Clone("hZUnf_SI1");
  hZUnf_SI1->Add(hZUnf_SI1_2);
  hZUnf_SI1->Add(hZUnf_SI1_3);
  hZUnf_SI1->Add(hZUnf_SI1_4);
  hZUnf_SI1->Add(hZUnf_SI1_5);
  ...
  hZUnf_SI2_1=(TH1D*)file2->Get("hMUnf_5_Iter3;1");
  hZUnf_SI2_2=(TH1D*)file2->Get("hMUnf_6_Iter3;1");
  hZUnf_SI2_3=(TH1D*)file2->Get("hMUnf_7_Iter3;1");
  hZUnf_SI2_4=(TH1D*)file2->Get("hMUnf_8_Iter3;1");
  hZUnf_SI2_5=(TH1D*)file2->Get("hMUnf_9_Iter3;1");

  hZUnf_SI2=(TH1D*)hZUnf_SI2_1->Clone("hZUnf_SI2");
  hZUnf_SI2->Add(hZUnf_SI2_2);
  hZUnf_SI2->Add(hZUnf_SI2_3);
  hZUnf_SI2->Add(hZUnf_SI2_4);
  hZUnf_SI2->Add(hZUnf_SI2_5);
  ...
  hZUnf_SI3_1=(TH1D*)file3->Get("hMUnf_5_Iter3;1");
  hZUnf_SI3_2=(TH1D*)file3->Get("hMUnf_6_Iter3;1");
  hZUnf_SI3_3=(TH1D*)file3->Get("hMUnf_7_Iter3;1");
  hZUnf_SI3_4=(TH1D*)file3->Get("hMUnf_8_Iter3;1");
  hZUnf_SI3_5=(TH1D*)file3->Get("hMUnf_9_Iter3;1");

  hZUnf_SI3=(TH1D*)hZUnf_SI3_1->Clone("hZUnf_SI3");
  hZUnf_SI3->Add(hZUnf_SI3_2);
  hZUnf_SI3->Add(hZUnf_SI3_3);
  hZUnf_SI3->Add(hZUnf_SI3_4);
  hZUnf_SI3->Add(hZUnf_SI3_5);
  ...
  hZUnf_SI4_1=(TH1D*)file4->Get("hMUnf_5_Iter3;1");
  hZUnf_SI4_2=(TH1D*)file4->Get("hMUnf_6_Iter3;1");
  hZUnf_SI4_3=(TH1D*)file4->Get("hMUnf_7_Iter3;1");
  hZUnf_SI4_4=(TH1D*)file4->Get("hMUnf_8_Iter3;1");
  hZUnf_SI4_5=(TH1D*)file4->Get("hMUnf_9_Iter3;1");

  hZUnf_SI4=(TH1D*)hZUnf_SI4_1->Clone("hZUnf_SI4");
  hZUnf_SI4->Add(hZUnf_SI2_2);
  hZUnf_SI4->Add(hZUnf_SI2_3);
  hZUnf_SI4->Add(hZUnf_SI2_4);
  hZUnf_SI4->Add(hZUnf_SI2_5);
...
void PlotRatios_MCUnfoldedTruth_v2(){
