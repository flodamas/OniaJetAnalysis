...
//#endif
  ...
  if(doPrompt && doMid){
    testInputName = Form("dataUnfNewMidBins/unfOutput/step4/UnfoldedDistributions_Prompt_Mid_8iter_49z15ptBins7zMeasBins%s.root",SF_name.c_str());
    trainInputName = "dataUnfNewMidBins/code/diag4DMatrixResponseInvMid.root";
    outputName = Form("dataUnfNewMidBins/unfOutput/step4/UnfoldedDistributions_Prompt_Mid_8iter_49z15ptBins7zMeasBins%s_Diag.root",SF_name.c_str());
  }

  if(doPrompt && !doMid){
    testInputName = Form("dataUnfNewMidBins/unfOutput/step4/UnfoldedDistributions_Prompt_Fwd_8iter_50z15ptBins%s.root",SF_name.c_str());
    trainInputName = "dataUnfNewMidBins/code/diag4DMatrixResponseInv.root";
    outputName = Form("dataUnfNewMidBins/unfOutput/step4/UnfoldedDistributions_Prompt_Fwd_8iter_50z15ptBins%s_Diag.root",SF_name.c_str());
  }
