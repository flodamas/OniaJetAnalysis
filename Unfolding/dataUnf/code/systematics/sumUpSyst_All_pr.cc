...
void add(bool doPrompt = true, bool doMid = true){
  ...
  if(doPrompt && doMid){
    ...
    name_quarkoniaSyst = "../unfResult_prompt_mid_wQSyst.root";
    ...
    outputfile = "../../unfOutput/totalSystErr/systErrs_Prompt_Mid_Total.root";
  }

  if(doPrompt && !doMid){
    cout <<"prompt fwd"<< endl;
    name_quarkoniaSyst = "../unfResult_prompt_fwd_wQSyst.root";
    ...
    outputfile = "../../unfOutput/totalSystErr/systErrs_Prompt_Fwd_Total.root";
  }
  ...
  for(int i = 0; i < zBins; i++){
    ...
    finalBinErr = TMath::Sqrt(binErr_unfTrMatrix*binErr_unfTrMatrix+binErr_unfSI*binErr_unfSI+binErr_JES*binErr_JES+binErr_JER*binErr_JER+binErr_JES_add*binErr_JES_add+binErr_quarkSyst*binErr_quarkSyst);
    ...
    cout << " bin content = " << binVal_unfTrMatrix  << " , " << binVal_unfSI << " , " << binVal_JES << " , " << binVal_JES_add << " , " << binVal_JER << " , " << binVal_quarkSyst  << endl;
