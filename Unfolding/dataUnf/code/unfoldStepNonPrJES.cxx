...
//#endif
  ...
  if(doPrompt && doMid){
    ...
    trainInputName = Form("dataUnfNewMidBins/unfInput/step%i/response_4D_prompt_midRapidity_49z15ptBins7zMeasBins_nonPrJES%s.root",stepNumber,SF_name.c_str());
    outputName = Form("dataUnfNewMidBins/unfOutput/step%i/UnfoldedDistributions_Prompt_Mid_8iter_49z15ptBins7zMeasBins_nonPrJES%s.root",stepNumber,SF_name.c_str());
  }
  if(doPrompt && !doMid){
    testInputName = "dataUnfNewMidBins/data_results/meas_data_prompt_fwd_statErrs.root";
    trainInputName = Form("dataUnfNewMidBins/unfInput/step%i/response_4D_prompt_fwdRapidity_50z15ptBins_nonPrJES%s.root",stepNumber,SF_name.c_str());
    outputName = Form("dataUnfNewMidBins/unfOutput/step%i/UnfoldedDistributions_Prompt_Fwd_8iter_50z15ptBins_nonPrJES%s.root",stepNumber,SF_name.c_str());
  }
...
void unfoldStepNonPrJES(Int_t step = 1, double SF = 1.1){
