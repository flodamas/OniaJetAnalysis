...
void create2DMeas_data_fwd_systErrs(bool doPrompt = true){
  ...
  filename1 = "../data_results/unfoldingInput_lowJtPt_rap1624_systErr.root";
  filename2 = "../data_results/unfoldingInput_midJtPt_rap1624_systErr.root";
  filename3 = "../data_results/unfoldingInput_highJtPt_rap1624_systErr.root";
  ...
  if(doPrompt){
    h_lowBin = (TH1F*)file1->Get("prHist_lowJtPt_rap1624_systErr;1");
    h_centBin = (TH1F*)file2->Get("prHist_midJtPt_rap1624_systErr;1");
    h_highBin = (TH1F*)file3->Get("prHist_highJtPt_rap1624_systErr;1");
  }
  else{
    h_lowBin = (TH1F*)file1->Get("nprHist_lowJtPt_rap1624_systErr;1");
    h_centBin = (TH1F*)file2->Get("nprHist_midJtPt_rap1624_systErr;1");
    h_highBin = (TH1F*)file3->Get("nprHist_highJtPt_rap1624_systErr;1");
  }
  ...
  if(doPrompt) can0->SaveAs("../plots/data_z_distr_promptFwd_systErr.pdf");
  else can0->SaveAs("../plots/data_z_distr_nonpromptFwd_systErr.pdf");
  ...
  if(doPrompt) can1->SaveAs("../plots/data_meas_promptFwd_systErr.pdf");
  else can1->SaveAs("../plots/data_meas_nonpromptFwd_systErr.pdf");

  string outputfile = "";
  if(doPrompt) outputfile = "../data_results/meas_data_prompt_fwd_systErrs.root";
  else outputfile = "../data_results/meas_data_nonprompt_fwd_systErrs.root";
