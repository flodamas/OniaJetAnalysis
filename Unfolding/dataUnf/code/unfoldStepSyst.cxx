...
//#endif
  ...
  if(doPrompt && doMid){
    testInputName = "dataUnfNewMidBins/data_results/meas_data_prompt_mid_systErrs.root";
    trainInputName = Form("dataUnfNewMidBins/unfInput/step%i/response_4D_prompt_midRapidity_49z15ptBins7zMeasBins_syst%s.root",stepNumber,SF_name.c_str());
    outputName = Form("dataUnfNewMidBins/unfOutput/step%i/UnfoldedDistributions_Prompt_Mid_8iter_49z15ptBins7zMeasBins_syst%s.root",stepNumber,SF_name.c_str());
  }
  if(doPrompt && !doMid){
    testInputName = "dataUnfNewMidBins/data_results/meas_data_prompt_fwd_systErrs.root";
    trainInputName = Form("dataUnfNewMidBins/unfInput/step%i/response_4D_prompt_fwdRapidity_50z15ptBins_syst%s.root",stepNumber,SF_name.c_str());
    outputName = Form("dataUnfNewMidBins/unfOutput/step%i/UnfoldedDistributions_Prompt_Fwd_8iter_50z15ptBins_syst%s.root",stepNumber,SF_name.c_str());
  }

  if(!doPrompt && doMid){
    testInputName = "dataUnfNewMidBins/data_results/meas_data_nonprompt_mid_systErrs.root";
    trainInputName = Form("dataUnfNewMidBins/unfInput/step%i/response_4D_nonprompt_midRapidity_49z15ptBins7zMeasBins_syst%s.root",stepNumber,SF_name.c_str());
    outputName = Form("dataUnfNewMidBins/unfOutput/step%i/UnfoldedDistributions_NonPrompt_Mid_8iter_49z15ptBins7zMeasBins_syst%s.root",stepNumber,SF_name.c_str());
  }
  if(!doPrompt && !doMid){
    testInputName = "dataUnfNewMidBins/data_results/meas_data_nonprompt_fwd_systErrs.root";
    trainInputName = Form("dataUnfNewMidBins/unfInput/step%i/response_4D_nonprompt_fwdRapidity_50z15ptBins_syst%s.root",stepNumber,SF_name.c_str());
    outputName = Form("dataUnfNewMidBins/unfOutput/step%i/UnfoldedDistributions_NonPrompt_Fwd_8iter_50z15ptBins_syst%s.root",stepNumber,SF_name.c_str());
  }
...
void unfoldStepSyst(Int_t step = 1, double SF = 1.1){
