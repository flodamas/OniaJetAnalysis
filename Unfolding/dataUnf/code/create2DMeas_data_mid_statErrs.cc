...
void create2DMeas_data_mid_statErrs(bool doPrompt = true){

  string filename1 = "";
  string filename2 = "";
  string filename3 = "";
  
  filename1 = "../data_results/unfoldingInput_lowJtPt_rap016_statErr.root";
  filename2 = "../data_results/unfoldingInput_midJtPt_rap016_statErr.root";
  filename3 = "../data_results/unfoldingInput_highJtPt_rap016_statErr.root";
  ...
  if(doPrompt){
    h_lowBin = (TH1F*)file1->Get("prHist_lowJtPt_rap016_statErr;1");
    h_centBin = (TH1F*)file2->Get("prHist_midJtPt_rap016_statErr;1");
    h_highBin = (TH1F*)file3->Get("prHist_highJtPt_rap016_statErr;1");
  }
  else{ 
    h_lowBin = (TH1F*)file1->Get("nprHist_lowJtPt_rap016_statErr;1");
    h_centBin = (TH1F*)file2->Get("nprHist_midJtPt_rap016_statErr;1");
    h_highBin = (TH1F*)file3->Get("nprHist_highJtPt_rap016_statErr;1");
  }
  ...
  if(doPrompt) can0->SaveAs("../plots/data_z_distr_promptMid_statErr.pdf");
  else can0->SaveAs("../plots/data_z_distr_nonpromptMis_statErr.pdf");
  ...
  if(doPrompt) can1->SaveAs("../plots/data_meas_promptMid_statErr.pdf");
  else can1->SaveAs("../plots/data_meas_nonpromptMid_statErr.pdf");

  
  string outputfile = "";
  if(doPrompt) outputfile = "../data_results/meas_data_prompt_mid_statErrs.root";
  else outputfile = "../data_results/meas_data_nonprompt_mid_statErrs.root";
