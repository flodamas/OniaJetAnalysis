...
void testAccEffBins(bool isData, bool isPbPb, int dimension, bool applyPtW, string caseTag) {
  ...
  if (!isPbPb && dimension>2) { cout <<"[WARNING] can't do centrality in PP! checking 2D corrections"<<endl; dimension=2;}
